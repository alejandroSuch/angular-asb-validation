...
describe('provider: asbValidationProvider', function () {
    var theProvider;
    var undefinedVar;

    beforeEach(module('asb.validation'));

    beforeEach(function () {
        // Initialize the service provider by injecting it to a fake module's config block
        var fakeModule = angular
            .module('test.app.config', function () {
            }).config(function (asbValidationProvider) {
                theProvider = asbValidationProvider;
            });

        // Initialize test.app injector
        module('asb.validation', 'test.app.config');
